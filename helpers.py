...
def draw_box_label(img, bbox_cv2, box_color=(0, 255, 255), vehicle_info={'color':0, 'model':0, 'weight':0}, show_label=True):
    '''
    ...
    if show_label:
        ...
        text_color= 'color:'+str(vehicle_info['color'])
        cv2.putText(img,text_color,(left,top-30), font, font_size, font_color, 1, cv2.LINE_AA)
        #text_model= 'model:'+str(vehicle_info['model'])
        #cv2.putText(img,text_model,(left,top-65), font, font_size, font_color, 1, cv2.LINE_AA)
        text_weight= 'weight:'+str(vehicle_info['weight'])
        cv2.putText(img,text_weight,(left,top-20), font, font_size, font_color, 1, cv2.LINE_AA)
